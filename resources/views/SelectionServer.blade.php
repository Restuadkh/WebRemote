              ...
              <div class="card-footer">
                <div class="form-group"> 
                  <div class="input-group date" id=""> 
                    <input type="text" class="form-control" id="datetimepicker_ram" name="datetimepicker_ram" placeholder="Select date and time">
        ...
        <div class="col-md-6 mt-2">
            <div class="card text-left">
              ...
              <div class="card-footer">
                <div class="form-group"> 
                  <div class="input-group date" id=""> 
                    <input type="text" class="form-control" id="datetimepicker_cpu" name="datetimepicker_cpu" placeholder="Select date and time">
